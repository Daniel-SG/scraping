    ...
    try:
        ...
        for category_page in sorted_category_page_list[:5]:
            ...
            while more_elements:
                ...
                pattern_url_image = f"//*[@id='octopus-dlp-asin-stream']/ul/li[{i}]/span/div/div[1]/a/img/@src"
                ...
                if len(parser.xpath(pattern_title)) > 0:
                    ...
                    image_url = str(parser.xpath(pattern_url_image)[0])
                    ...
                    if amazon_url not in used_links and reduction_price > biggest_discount:
                        ...
                        most_discount_product = (
                            reduction_price_str, title_product, amazon_url, final_product_price, old_price,image_url)
            ...
            if len(most_discount_product) > 0:
                ...
                print('Url image ' + str(most_discount_product[5] + '\n'))
